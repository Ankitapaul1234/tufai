...
// import { zodResolver } from "@hookform/resolvers/zod";
// import useFetch from "@/hooks/use-fetch";
// import dynamic from "next/dynamic"; // Dynamically import Textarea to avoid SSR issues

// const Textarea = dynamic(() => import("@/components/ui/textarea"), { ssr: false });

// const ResumeBuilder = ({ initialContent }) => {
//   // ✅ FIX: Ensure consistent tab state across SSR & CSR
...
// // Load StartRes dynamically, only on client
// const StartRes = dynamic(() => import("./start-res"), { ssr: false });

// const ResumeBuilder = ({ initialContent }) => {
//   const [activeTab, setActiveTab] = useState(null); // Prevent hydration mismatch
...
//   const { fn: saveResumeFn } = useFetch(saveResume);

//   // Fix: Ensure activeTab is set only in client-side
//   useEffect(() => {
//     setActiveTab(initialContent ? "preview" : "edit");
//   }, [initialContent]);

//   // Ensure no SSR-related hydration issues
...
//                 name="experience"
//                 control={control}
//                 render={({ field }) => <StartRes type="Experience" entries={field.value} onChange={field.onChange} />}
//               />
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <Textarea {...field} className="h-32" placeholder="List your key skills..." value={field.value || ""} />
                )}
              />
            ...
            <div className="space-y-4">
              ...
              <Controller
                name="education"
                control={control}
                render={({ field }) => <StartRes type="Education" entries={field.value || []} onChange={field.onChange} />}
              />
            ...
            <div className="space-y-4">
              ...
              <Controller
                name="projects"
                control={control}
                render={({ field }) => <StartRes type="Project" entries={field.value || []} onChange={field.onChange} />}
              />
